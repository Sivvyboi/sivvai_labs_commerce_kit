...
import { sendAdminInvitationAction } from "@/features/admin/actions/invitations.actions";
      ...
      >
        ...
        {success ? (
          <div className="space-y-4 text-center py-4">
            ...
            <p className="text-sm font-medium text-[var(--kit-text-primary)]">Invitation sent to <strong>{email}</strong></p>
            <p className="text-xs text-[var(--kit-text-muted)]">They will receive an email with a link to set up their account.</p>
            <button
              type="button"
              onClick={handleClose}
