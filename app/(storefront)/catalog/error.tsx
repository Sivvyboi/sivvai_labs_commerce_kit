"use client";
/**
 * app/(storefront)/catalog/error.tsx
 *
 * Catalog Page Error Boundary.
 * Catches server-side errors during product fetching.
 */
      ...
      <div className="flex flex-col items-center justify-center gap-6 text-center">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-[var(--kit-muted-fg)] max-w-sm mx-auto">
            We couldn&apos;t load the product catalog right now. Please try again or check your connection.
          </p>
        </div>
        <button
          type="button"
