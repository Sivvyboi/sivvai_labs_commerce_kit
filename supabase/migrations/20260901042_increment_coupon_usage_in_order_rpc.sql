-- =============================================================================
-- 20260901042_increment_coupon_usage_in_order_rpc.sql
--
-- Fix: Atomic increment of coupon_codes.current_uses upon successful
-- order creation in create_order_from_checkout_rpc.
-- =============================================================================
